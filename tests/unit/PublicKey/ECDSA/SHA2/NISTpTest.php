...
class NISTpTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $key = new \Clicky\Pssht\PublicKey\ECDSA\SHA2\NISTp256(
        ...
        $rng = new \Clicky\Pssht\Random\Fixed(
    ...
    {
        $key = new \Clicky\Pssht\PublicKey\ECDSA\SHA2\NISTp384(
            new \Clicky\Pssht\ECC\Point(
    ...
    {
        $key = new \Clicky\Pssht\PublicKey\ECDSA\SHA2\NISTp521(
            new \Clicky\Pssht\ECC\Point(
